          ...
          <div className="container mx-auto max-w-5xl">
            ...
            >
              <div className="p-8 md:p-10">
                ...
                <div className="bg-blue-50/50 py-3.5 px-5 rounded-r-lg rounded-l-none border-l-4 border-primary border-t-0 border-r-0 border-b-0 my-4 w-full">
                ...
                <div className="text-center">
                  ...
                  <p className="mt-4 text-xs text-slate-500 font-medium">
                    ✓ 100% Independent assessment • No software kickbacks • If a tool works, I leave it alone.
                  </p>
                </div>
              </div>
            </motion.div>
